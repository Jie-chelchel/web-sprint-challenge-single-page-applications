...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   useRouteMatch provides access to the match project. It gives you information on how the Route matched. You can
   invoke it with no arguments and get the app's current path and url.

1. How would you explain form validation to someone who has never programmed before?
   Form validation is something the web developer used to check if the information provided by a user is correct. The form will tell the user hat they messed up and need to fix something to proceed.

1. In 1-2 sentences, define end to end testing.
   End to end testing is a testing method that involves testing an application's workflow from beginning to the end. The main purpose of the test is to test form the end user’s experience by simulating the real user scenario and validating the system.
